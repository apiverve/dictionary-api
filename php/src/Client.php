 ...
 * ```
 *
 * @see https://dictionary.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dictionary';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DictionaryClient] {$message}\n";
        }
    }
}
