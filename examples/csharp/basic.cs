/*
 * Dictionary API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Dictionary API.
 * API Documentation: https://docs.apiverve.com/ref/dictionary
 */
...
namespace APIVerve.Examples
{
    class DictionaryExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/dictionary";

        /// <summary>
        /// Make a GET request to the Dictionary API
        /// </summary>
        static async Task<JsonDocument> CallDictionaryAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;word&quot;] &#x3D; &quot;apple&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Dictionary API...\n");

            var result = await CallDictionaryAPI();
