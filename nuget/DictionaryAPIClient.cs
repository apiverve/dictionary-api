...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/dictionary";
        ...
        public DictionaryAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DictionaryAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DictionaryAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DictionaryQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DictionaryQueryOptions options)
        {
        ...
        public ResponseObj Execute(DictionaryQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DictionaryQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DictionaryQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DictionaryQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DictionaryQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DictionaryQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DictionaryQueryOptions options)
        {
