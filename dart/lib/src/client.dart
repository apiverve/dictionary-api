...
class DictionaryValidationException implements Exception {
  final List<String> errors;

  DictionaryValidationException(this.errors);

  @override
  String toString() => 'DictionaryValidationException: ${errors.join("; ")}';
}
...
///
/// For more information, visit: https://dictionary.apiverve.com?utm_source=dart&utm_medium=readme
///
/// Parameters:
/// * [word] (required) - The word for which you want to get the definition (e.g., apple)
class DictionaryClient {
  ...
  void _validateParams(Map<String, dynamic> params) {
    ...
    if (errors.isNotEmpty) {
      throw DictionaryValidationException(errors);
    }
  }

  /// Execute a request to the Dictionary API.
  ///
  /// Parameters are validated before sending the request.
  Future<DictionaryResponse> execute(Map<String, dynamic> params) async {
    // Validate parameters
    _validateParams(params);
    if (apiKey.isEmpty) {
      throw DictionaryException('API key is required. Get your API key at: https://apiverve.com');
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw DictionaryException('Invalid API key');
      } else if (response.statusCode == 404) {
        throw DictionaryException('Resource not found');
      } else {
        throw DictionaryException('API error: ${response.statusCode}');
      }
    } catch (e) {
      if (e is DictionaryException) rethrow;
      throw DictionaryException('Request failed: $e');
    }
  }
...
/// Exception thrown by the Dictionary API client.
