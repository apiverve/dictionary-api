// Package dictionary provides a Go client for the Dictionary API.
//
// For more information, visit: https://dictionary.apiverve.com?utm_source=go&utm_medium=readme
package dictionary
...
const (
	baseURL        = "https://api.apiverve.com/v1/dictionary"
	defaultTimeout = 30 * time.Second
)

// Client is the Dictionary API client.
type Client struct {
	apiKey     string
...
// Execute makes a request to the Dictionary API with typed parameters.
//
...
//   - word (required): string - The word for which you want to get the definition (e.g., apple)
