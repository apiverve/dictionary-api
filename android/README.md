...
```gradle
dependencies {
    implementation 'com.github.apiverve:dictionary-api:1.1.14'
}
```
...
```java
import com.apiverve.dictionary.DictionaryAPIClient;
import com.apiverve.dictionary.APIResponse;
import com.apiverve.dictionary.APIException;

// Initialize the client
DictionaryAPIClient client = new DictionaryAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "apple");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dictionary](https://docs.apiverve.com/ref/dictionary)
...
- **Documentation:** [https://docs.apiverve.com/ref/dictionary](https://docs.apiverve.com/ref/dictionary)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dictionary-api/issues)
